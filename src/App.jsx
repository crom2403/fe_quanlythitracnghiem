      ...
      <Router>
        <Routes>
          <Route path={path.PUBLIC} element={<Public />}>
            ...
            <Route
              path={path.Question123.substring(1)}
              element={<Question123 />}
            />
            ...
            <Route
              path={path.EXAMMANAGEMENT.substring(1)}
              element={<Examanagement />}
            />
            <Route
              path={path.COURSEMANAGEMENT.substring(1)}
              element={<CourseManagement />}
            />

            <Route
              path={path.COURSEGROUP.substring(1)}
            ...
            />
            <Route
              path={path.FINISHEDTEST.substring(1)}
