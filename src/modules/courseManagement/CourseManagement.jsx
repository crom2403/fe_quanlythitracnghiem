...
const CourseManagement = () => {
  ...
  const [courseForm, setCourseForm] = useState({ id: '', public_id: '', name: '', credits: '', theory_hours: '', practical_hours: '' });
    ...
    try {
      if (isEditing) {
        ...
        setCourses(courses.map(course => 
          course.id === courseForm.public_id ? { id: courseForm.public_id, ...courseData } : course
        ));
        showNotification('Cập nhật môn học thành công');
      } else {
        const response = await axios.post('/subject', courseData);
        setCourses([...courses, { id: response.data.public_id, ...courseData }]);
        showNotification('Thêm môn học thành công');
      }

      setShowAddModal(false);
      setCourseForm({ id: '', public_id: '', name: '', credits: '', theory_hours: '', practical_hours: '' });
      setIsEditing(false);
    } catch (error) {
            ...
            <div className="space-y-4">
              <div>
                ...
                <input 
                  ...
                  onChange={(e) => setCourseForm({...courseForm, public_id: e.target.value})}
                  disabled={isEditing}
                />
              </div>
              ...
              <div>
                ...
                <input 
                  ...
                  onChange={(e) => setCourseForm({...courseForm, theory_hours: parseInt(e.target.value) || ''})}
                />
              </div>
              ...
              <div>
                ...
                <input 
                  ...
                  onChange={(e) => setCourseForm({...courseForm, practical_hours: parseInt(e.target.value) || ''})}
                />
              </div>
            </div>
